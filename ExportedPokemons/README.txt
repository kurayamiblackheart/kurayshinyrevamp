...
To re-import a Pokemon, drag its .json file into the "Import" folder, and use the "Import" action in the PC (by selecting a box).
All .json of Pokemons that are in the "Import" folder will get imported.
